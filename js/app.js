          ...
          <div class="imp-pane ${importMode === 'extension' ? 'on' : ''}" id="imp-extension">
            <div class="imp-ext">
              <div class="imp-ext-hero">
                ...
                <a class="imp-ext-download" href="https://github.com/kxbbw81-glitch/PromptHub-/raw/main/PromptHub-Extension-v3.3.zip" download="PromptHub-Extension-v3.3.zip" aria-label="下载 PromptHub 浏览器插件 v3.3">↓ 下载浏览器插件 <span>v3.3</span></a>
              </div>
