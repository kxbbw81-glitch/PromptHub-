          ...
          <div class="imp-pane ${importMode === 'extension' ? 'on' : ''}" id="imp-extension">
            <div class="imp-ext">
              <div class="imp-ext-hero">
                ...
                <a class="imp-ext-download" href="https://github.com/kxbbw81-glitch/PromptHub-/raw/main/PromptHub-Extension-v3.7.0.zip" download="PromptHub-Extension-v3.7.0.zip" aria-label="下载 PromptHub 浏览器插件 v3.7.0">↓ 下载浏览器插件 <span>v3.7.0</span></a>
              </div>
